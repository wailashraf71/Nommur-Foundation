...
@section('content')
    ...
    <!--? Hero Start -->
    <div class="slider-area2" style="background-image: url('https://images.pexels.com/photos/3280130/pexels-photo-3280130.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')">
    ...
    <!-- Map Start -->
    <div class="d-none d-sm-block mb-5 pb-5 container section-padding30">
